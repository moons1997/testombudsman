...
import { Permission, Translate } from "../../components/Webase/functions/index";
import {
  Card,
  Row,
  Col,
...
import DashboardService from "../../services/other/dashboard.service";
import dashboardStyle from "./dasboardStyle.css";
...
class Dashboard extends Component {
          ...
          locales: [
            {
              ...
              options: {
                toolbar: {
                  exportToSVG: t2("exportToSVG", this.props.intl),
                  exportToPNG: t2("exportToPNG", this.props.intl),
                  exportToCSV: t2("exportToCSV", this.props.intl),
                },
              },
            },
          ],
  ...
  Refresh() {
    if (can("DashboardView")) {
      DashboardService.GetDashboardData().then((res) => {
        var series = [
          {
            name: t2("checkingcount", this.props.intl),
            data: res.data.byRegions.map((item) => item.inspectionsCount),
          },
        ];
        var data = {
          xaxis: {
            categories: res.data.byRegions.map((item) => item.region),
          },
        };
        var dataP1 = [
          { name: "agreedCount", value: res.data.agreementResult.agreedCount },
          {
            name: "analysingCount",
            value: res.data.agreementResult.analysingCount,
          },
          {
            name: "rejectedCount",
            value: res.data.agreementResult.rejectedCount,
          },
        ];
        this.setState({ dataP1: dataP1 });
        this.setState({ series: series });
        this.setState({ data: data });
        this.setState({ DashboardList1: res.data });
        this.setState({ InfoDashboard: res.data.agreementResult });
        this.setState({ Info2Dashboard: res.data.inspectionStatus });
      });
    } else {
      //asasasasas
    }
  ...
  togglePopover(item) {
    this.setState({
      popoverOpen: "popoverOpen" + item.regionId,
    });
  }
  togglePopover13 = () => {
    this.setState({
      popoverOpen13: !this.state.popoverOpen13,
    });
  };
  toggleModal = () => {
          ...
          >
            <Card>
              <Row>
                ...
                color="primary"
              > */}
                  <Icon.Globe size={18} /> {t1("myGovcontrolUz")}
                  {/* </Button> */}
                </a>
                  ...
                  <Row>
                    <Col sm={12} md={12} lg={6}>
                      <ResponsiveContainer width={300}>
                        <PieChart width={"440vh"} height={"40vh"}>
                          <Pie
                            data={dataP1}
                            cx="40%"
                            cy="50%"
                    ...
                    <Col sm={12} md={12} lg={6}>
                      <div style={{ marginTop: "25%", width: "60vh" }}>
                        <p
                          className="m-0 p-0 text-bold-600"
                          style={{
                            fontSize: "18px",
                            // fontFamily: "Times New Roman",
                          }}
                        ...
                        <Row>
                          <Col sm={12} lg={1}>
                            <div className="classDiv c-1"></div>
                          </Col>
                          <Col sm={12} lg={11}>
                            {" "}
                            <p
                        ...
                        <Row>
                          <Col sm={12} lg={1}>
                            <div className="classDiv c-2"></div>
                          </Col>
                          <Col sm={12} lg={11}>
                            {" "}
                            <p
                        ...
                        <Row>
                          <Col sm={12} lg={1}>
                            <div className="classDiv c-3"></div>
                          </Col>
                          <Col sm={12} lg={11}>
                            {" "}
                            <p
                        ...
                        <Row>
                          <Col sm={12} lg={1}>
                            <div className="classDiv c-4"></div>
                          </Col>
                          <Col sm={12} lg={11}>
                            {" "}
                            <p
                        ...
                        <Row>
                          <Col sm={12} lg={1}>
                            <div className="classDiv c-5"></div>
                          </Col>
                          <Col sm={12} lg={11}>
                            {" "}
                            <p
            ...
            <div>
              {DashboardList1.byRegions?.map((item, index) => (
                <>
                  {item.regionId == 14 ? (
                    <Popover
                      placement="top"
                      target={"controlledPopover14"}
                      isOpen={
                        this.state.popoverOpen == "popoverOpen" + item.regionId
                          ? true
                          : false
                      }
                      toggle={() => {
                        ...
                        <PopoverBody>
                          ...
                          >
                            <Row>
                              ...
                              <Col>{item.inspectionsCount}</Col>
                            </Row>
                            <Row>
                              <Col sm={12} lg={8}>
                                {t1("beginnedCount")}:
                              </Col>
                              <Col>{item.beginnedCount}</Col>
                            </Row>
                            <Row>
                              <Col sm={12} lg={8}>
                                {t1("lastInspectionStartDate")}:
                              </Col>
                              <Col>{item.lastInspectionStartDate}</Col>
                            </Row>
                          </div>
                        </PopoverBody>
                      </>
          ...
          <div>
            <Card className="text-center">
              <Row>
                <Col sm={12} lg={1}></Col>
                <Col>
                  <img className="text-center" width="60%" src={UzbEmblem} />
                </Col>
                <Col sm={12} lg={1}></Col>
              </Row>
            </Card>
            <Modal
              ...
              className="modal-lg text-center"
            >
              ...
              <ModalBody>
                ...
                >
                  Мазкур бўлимда махсус гувохномага эга бўлган хамда кадрлар
                  билан ишлаш бўйича назорат қилувчи орган мансабдор шахслари
                  тўғрисидаги маълумотлар киритилади. Бўлинмага киритилган
                  маълумотлар асосида Ўзбекистон Республикаси Президентининг
                  2021 йил 15 сентябрдаги “Тадбиркорлик субъектлари учун
                  маъмурий ва солиқ юкини янада камайтириш, бизнеснинг қонуний
                  манфаатларини ҳимоя қилиш тизимини такомиллаштириш
                  чора-тадбирлари тўғрисида”ги ПФ-6314-сон Фармони билан
                  белгиланган “Тадбиркорлик субъектлари фаолиятини текшириш
                  ҳуқуқига эга мансабдор шахсларнинг электрон реестри”
                  шакллантирилиб, ушбу маълумотлар тизим фойдаланувчиларига
                  очиқланади. Ўзбекистон Республикасининг “Шахсга доир
                  маълумотлар тўғрисида”ги Қонунига мувофиқ, мансабдор шахслар
                  тўғрисидаги маълумотларни тизимга киритишда уларнинг эътирози
                  йўқлигини аниқлаштиришингиз сўралади. Шу билан бирга,
                  Тадбиркорлик субъектлари фаолиятини текшириш ҳуқуқига эга
                  мансабдор шахсларнинг электрон реестрига киритилмаган
                  мансабдор шахсларга тизимдан фойдаланиш имконияти мавжуд
                  бўлмаслиги ҳақида огохлантирамиз.
                </p>
              </ModalBody>
              <ModalFooter>
