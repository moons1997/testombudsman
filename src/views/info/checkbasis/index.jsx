...
class CheckBasis extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: [
        ...
        { key: "checkType", label: t2("checkTypeId", props.intl), sort: true },
        {
          key: "state",
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={CheckBasisService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("CheckBasisEdit"),
                      router: "/info/edit" + routerName,
                    },
                    delete: {
                      isView: can("CheckBasisDelete"),
                    },
                  };
                }}
              ></WebaseTable>
...
export default injectIntl(CheckBasis);
