        ...
        <Card className="p-2">
          ...
          <Row>
            ...
            <Col sm={12} md={6} lg={8} className="text-right">
              ...
              {can("CitizenshipCreate") ? (
                <Button
                  color="primary"
                  onClick={() => history.push(`/info/editcitizenship/0`)}
                >
                  {" "}
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={CitizenshipService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("CitizenshipEdit"),
                      router: "/info/editcitizenship",
                    },
                    delete: {
                      isView: can("CitizenshipDelete"),
                    },
                  };
                }}
              />
