...
class VideoCategory extends React.Component {
  ...
  render() {
    ...
    const routerName = "videocategory";
    return (
      <div>
        <Card className="p-2">
          <Row>
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={VideoCategoryService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("VideoCategoryEdit"),
                      router: "/info/edit" + routerName,
                    },
                    delete: {
                      isView: can("VideoCategoryDelete"),
                    },
                  };
                }}
              />
...
export default injectIntl(VideoCategory);
