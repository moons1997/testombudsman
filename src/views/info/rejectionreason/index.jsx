        ...
        <Card className="p-2">
          ...
          <Row>
            ...
            <Col sm={12} md={6} lg={8} className="text-right">
              ...
              {can("RejectionReasonCreate") ? (
                <Button
                  color="primary"
                  onClick={() => history.push(`/info/editrejectionreason/0`)}
                >
                  {" "}
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={RejectionReasonService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("RejectionReasonEdit"),
                      router: "/info/editrejectionreason",
                    },
                    delete: {
                      isView: can("RejectionReasonDelete"),
                    },
                  };
                }}
              />
...
export default injectIntl(RejectionReason);
