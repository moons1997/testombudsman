...
class OrganizationInspectionType extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: [
  ...
  render() {
    ...
    const routerName = "organizationinspectiontype";
    return (
      <div>
        <Card className="p-2">
          <Row>
          ...
          <Row>
            ...
            <Col sm={12} md={6} lg={8} className="text-right">
              ...
              {can("OrganizationInspectionTypeCreate") ? (
                <Button
                  color="primary"
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={OrganizationInspectionTypeService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("OrganizationInspectionTypeEdit"),
                      router: "/info/edit" + routerName,
                    },
                    delete: {
                      isView: can("OrganizationInspectionTypeDelete"),
                    },
                  };
                }}
              />
...
export default injectIntl(OrganizationInspectionType);
