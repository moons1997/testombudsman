...
class ControlFunctionForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: [
  ...
  render() {
    ...
    const routerName = "controlfunctionform";
    return (
      <div>
        <Card className="p-2">
          <Row>
          ...
          <Row className="mt-2">
            <Col>
              <WebaseTable
                fields={fields}
                filter={filter}
                api={ControlFunctionFormService}
                childRef={(ref) => (this.child = ref)}
                actions={() => {
                  return {
                    edit: {
                      isView: can("ControlFunctionFormEdit"),
                      router: "/info/edit" + routerName,
                    },
                    delete: {
                      isView: can("ControlFunctionFormDelete"),
                    },
                  };
                }}
              />
...
export default injectIntl(ControlFunctionForm);
