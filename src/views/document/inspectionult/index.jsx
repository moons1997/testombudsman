...
import changeAllFilter from "../../../redux/actions/filters/inspectionresult";
...
class InspectionResult extends React.Component {
  constructor(props) {
    ...
    this.state = {
        ...
        },
        {
          ...
          search: () => {
            ...
            return (
              ...
              //       ? moment(this.state.filters.docDate.value, "DD.MM.YYYY")
              //       : ""
              //   }
      ...
      fields: [
        ...
        {
          key: "docDate",
          label: t2("requestDocDate", props.intl),
          sort: true,
        },
        {
          key: "startDate",
          label: t2("startDateRes", props.intl),
          sort: true,
        },
        {
          key: "endDate",
          label: t2("endDateRes", props.intl),
          sort: true,
        },
        // {
        //   key: "reason",
  ...
  GetExcel() {
    ...
    InspectionResultService.SaveAsExecel(this.state.filter)
      .then((res) => {
  ...
  forceFileDownload(response, name, attachfilename) {
    ...
    link.href = url;
    // if (format.length > 0) {
    link.setAttribute("download", t2("InspectionResult", intl) + "." + "xlsx");
    // }
        ...
        <Card className="p-2">
          <Row>
            <Col className="text-center">
              <h1 className="pageTextView"> {t1("InspectionResult")}</h1>
            </Col>
          </Row>
          <Row>
            <Col sm={12} md={6} lg={4}>
              ...
              <WebaseTable
                ...
                actions={(id) => {
                  return {
                    view: {
                      isView: true,
                      router: "/document/viewInspection",
                    },
                    edit: {
                      isView:
                        (can("RequestView") ||
...
const mapStateToProps = (state) => {
  return {
    values: state.filters.inspectionresult,
  };
};
