...
const languages = [
  { value: "english", label: "English", color: "#4177C9" },
  { value: "french", label: "French", color: "#4177C9" },
  { value: "spanish", label: "Spanish", color: "#4177C9" },
  { value: "russian", label: "Russian", color: "#4177C9" },
  { value: "italian", label: "Italian", color: "#4177C9" },
];

const colourStyles = {
  control: (styles) => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#4177C9";
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#4177C9"),
      },
    };
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#4177C9",
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#4177C9",
      color: "white",
    },
  }),
};
