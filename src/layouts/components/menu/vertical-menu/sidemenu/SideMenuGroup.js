...
import { Permission } from "../../../../../components/Webase/functions/index";
...
class SideMenuGroup extends React.Component {
  ...
  displayNone = (item) => {
    ...
    if (typeof item == "object") {
      if (item.length > 0) {
        if (item.filter((el) => can(el) == true).length > 0) {
          return false;
        } else {
          return true;
        }
                ...
                return (
                  <li
                    ...
                    className={classnames({
                      ...
                      "d-none": this.displayNone(child.visible),
                      "bg-primary": false,
                    })}
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    ...
                    >
                      ...
                      {child.badge ? (
                        <Badge
                          color={child.badge}
                          className="float-right mr-2 bg-danger"
                          pill
                        >
                          {child.badgeText}
                        </Badge>
